...
import static org.uzxteam.db.entity.SourceType.FILE;
import static org.uzxteam.db.entity.SourceType.UNSUPPORTED;
import static org.uzxteam.db.entity.SourceType.URL;
...
public class HostsSource {
     ...
     * The user source URL.
     */
    public static final String USER_SOURCE_URL = "content://org.uzxteam/user/hosts";
